    ...
    <div class="container">
      <div class="columns">
        <div class="column is-two-thirds is-offset-2">
          <h1 class="title">แบบประเมินภาวะโภชนาการ (Mini Nutritional Assessment)</h1>
          <b-field
              label="ในช่วงสามเดือนที่ผ่านมารับประทานอาหารได้น้อยลง เนื่องจากความอยากอาหารลดลง มีปัญหาการย่อย การเคี้ยว หรือปัญหาการกลืนหรือไม่">
          ...
          <b-field>
            <b-radio native-value=1 v-model="form.record.mna.three">ลุกจากเตียงหรือรถเข็นได้บ้าง
              แต่ไม่สามารถไปข้างนอกเองได้
            </b-radio>
          </b-field>
          <b-field>
          ...
          <b-field>
            <b-radio :readonly="true" native-value=1 v-model="form.record.mna.six">BMI ตั้งแต่ 19 แต่น้อยกว่า 21
            </b-radio>
          </b-field>
          <b-field>
            <b-radio :readonly="true" native-value=2 v-model="form.record.mna.six">BMI ตั้งแต่ 21 แต่น้อยกว่า 23
            </b-radio>
          </b-field>
          <b-field>
