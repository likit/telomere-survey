  ...
  <section class="section">
    ...
    <div class="container">
      ...
      <b-field label="Balance Test">
        <b-numberinput placeholder="คะแนน" step="0.1" v-model="form.record.evaluation.balanceTestScore"></b-numberinput>
      </b-field>
      <b-field label="Gait Speed Test">
        <b-numberinput placeholder="คะแนน" step="0.1" v-model="form.record.evaluation.gaitSpeedScore"></b-numberinput>
      </b-field>
      <b-field label="Chair Stand Test">
        <b-numberinput placeholder="คะแนน" step="0.1" v-model="form.record.evaluation.ChairStandScore"></b-numberinput>
      </b-field>
      <br>
